/datum/coven/eora
	name = "Eoran Embrace"
	desc = "Blessed by the Goddess of Love, Family, and Art, Astrata's slave, these vampires have developed powers that strengthen bonds, inspire beauty, and heal emotional wounds."
	icon_state = "eora"
