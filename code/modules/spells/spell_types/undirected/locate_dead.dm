/datum/action/cooldown/spell/undirected/locate_dead
	...
	invocation = "Underlord, guide my hand to those who have lost their way."
...
/datum/action/cooldown/spell/undirected/locate_dead/cast(atom/cast_on)
	...
	if(!length(corpses))
		to_chat(owner, span_warning("The Underlord's grasp lets slip."))
		return .
	...
	to_chat(owner, span_notice("The Underlord pulls on your hand, guiding you [direction_name]."))
