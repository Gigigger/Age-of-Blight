...
/mob/living/simple_animal/hostile/retaliate/shade
	...
	name = "shade"
	desc = "An unquiet spirit of the dead, seeking to drag the living with them. Said to be those who could not pay their Toll to the Underlord's carriageman, or cursed servants of the Z-Not-To-Be-Named that are shackled to him even in death."
